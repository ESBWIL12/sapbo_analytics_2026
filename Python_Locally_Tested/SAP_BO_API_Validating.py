...
def main():
    ...
    # Second Credientials
    # username = "NLMBHA2"
    # password = "Reset@98982424"
    #------------------------Block to switch between Dev and Prod settings---------------------------
    ### Production SAP BO REST Server URL 
    bo_url = "https://wavgbcdfp1088.atradiusnet.com:8443/biprws/"
    ### Extracted File Path - Production
    # FolderPath=r"C:\Users\esbwil1\Atradius\Data Platform Team - Squad 1 # Scope & Inventory\04 BO Exploration\CMS Extraction\Python_WEBI_SQL_extraction\Prod_Extraction"
    ### New location for Production Extraction
    FolderPath=r"C:\Users\esbwil1\Atradius\Data Platform Team - Workstream #1 - SAP BO Analysis and Inventory\04 BO Exploration\CMS Extraction\Python_WEBI_SQL_extraction\Prod_Extraction"
    ###Production Connection Dictionary File
    connection_dictionaryFile=f"C:\\Users\\esbwil1\\OneDrive - Atradius\\Documents\\Python Scripts\\Script_OutPut\\Prod_Universe_ConnectionID.xlsx"

    # ## Development SAP BO REST Server URL 
    # bo_url = "https://bobidev.atradiusnet.com:8443/biprws/"
    # ## Extracted File Path - Development
    # FolderPath=r"C:\Users\esbwil1\Atradius\Data Platform Team - Squad 1 # Scope & Inventory\04 BO Exploration\CMS Extraction\Python_WEBI_SQL_extraction\Dev"
    # ##Development Connection Dictionary File
    # connection_dictionaryFile=f"C:\\Users\\esbwil1\\OneDrive - Atradius\\Documents\\Python Scripts\\Script_OutPut\\Dev_Uni_ConnectionID.xlsx"
    #------------------------Block to switch between Dev and Prod settings---------------------------

    username = "ESBWIL1"
    password = "ATMarkWise5@3"
    auth_type = "secLDAP"
    # Development File Path
    # FolderPath=r"C:\Users\esbwil1\OneDrive - Atradius\Documents\Python Scripts\Script_OutPut\Dev_Test"
    SourceFileName="Report_list.csv"
    ...
    Report_list_filename:str=f"C:\\Users\\esbwil1\\OneDrive - Atradius\\Documents\\Python Scripts\\Script_OutPut\\{SourceFileName}"
    ...
    try:
        ...
        logging.error(f"Failed to logon SAP BO Server: {logon_url} with error: {e}, exiting script.")
        log_status = False
        return
